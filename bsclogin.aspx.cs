...
public partial class bsclogin : System.Web.UI.Page
{
    ...
    protected void login1_Click(object sender, EventArgs e)
    {
        ...
        SqlConnection con = new SqlConnection("Data Source=Dell\\sqlexpress;Initial Catalog=learning;Integrated Security=True;Pooling=False");
        SqlCommand cmd = new SqlCommand("select * from bsclogin where username=@username and password=@password", con);
        ...
        if (dt.Rows.Count > 0)
        {
            Response.Redirect("bschome.aspx");
        }
        else
        {
