   ...
   protected void UploadFilec(object sender, EventArgs e)
    {
        ...
        if (FileUpload2.HasFile)
        {
          ...
          SqlCommand cmd = new SqlCommand("insert into stassign1(studentid, assignname,assigndata,subjectname,marks,sem) values('" + sid.Text + "','" + sname.Text + "','" + location2 + "','" + ssname.Text + "','" + m1 + "','" + sem.Text+ "')", con);
          con.Open();
